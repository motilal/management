            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="dataTable_wrapper">
                        <?php echo form_open('admin/pages/actions', array("id" => "table-form", "method" => "post")); ?>  
                                    ...
                                    <?php foreach ($result->result() as $key => $row): ?>
                                        <tr class="<?php echo ($key % 2 == 0) ? "even" : "odd"; ?> gradeX">
                                            ...
                                            <td class="center action-link">
                                                <a href="<?php echo site_url('admin/pages/manage/' . $row->id); ?>" title="Edit"> <span class="fa fa-edit"></span> </a>
