                    ...
                    <div class="dataTable_wrapper">
                        <div id="dataTables-grid_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <?php echo form_open('admin/cities/index', array("id" => "search-form", "method" => "get")); ?>
                            ...
                            <?php echo form_open('admin/cities/actions', array("id" => "table-form", "method" => "post")); ?>
                            <div class="row">
                                <div class="col-sm-12"> 
                                        ...
                                        <thead>
                                            <tr role="row" class="order-heading">
                                                ...
                                                <th><a href="<?php
                                                    ...
                                                    echo $sort1->url;
                                                    ?>" class="<?php echo $sort1->class; ?>">City Name</a></th>
                                                <th><a href="<?php
                                                    $sort2 = sorting_url('state_name');
                                                    echo $sort2->url;
                                                    ?>" class="<?php echo $sort2->class; ?>">State Name</a></th>
                                                <th><a href="<?php
                                                ...
                                                <?php foreach ($result->result() as $key => $row): ?>
                                                    <tr class="<?php echo ($key % 2 == 0) ? "even" : "odd"; ?> gradeX">
                                                        ...
                                                        <td class="center action-link">
                                                            <a href="<?php echo site_url('admin/cities/manage/' . $row->id); ?>" title="Edit"> <span class="fa fa-edit"></span> </a>
...
<script>
    $(document).ready(function () {
        ...
        $('#perpage_list').on('change', function () {
            var val = $(this).val();
            if (val > 0) {
                window.location = "<?php echo site_url('admin/cities/index?perpage='); ?>" + val;
            }
        });
